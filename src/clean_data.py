...
#  create dictionary of subcategories to assign each
#  profile to the appropriate broader category and field
subcat_dict = dict()
...
wik_profiles_toclean[['count_female_words',
                      'count_male_words',
...
wik_profiles_toclean['female'] = [True if x > y
                                  ...
                                  for x, y
                                  in zip(wik_profiles_toclean['count_female_words'],
                                         wik_profiles_toclean['count_male_words'])]
...
non_binary = wik_profiles_toclean[
    wik_profiles_toclean['gender_unclear'] is True]

#  where gender is unclear, it appears that these profiles
#  tend to be in another language or are too short
...
#  Keep profiles where gender can be determined
#  from the counts of gendered words in wikipedia profile
wik_profiles = wik_profiles_toclean[
    wik_profiles_toclean['gender_unclear'] is False].copy()

#  label each profile with the appropriate field and broader category
category = []
here = []
